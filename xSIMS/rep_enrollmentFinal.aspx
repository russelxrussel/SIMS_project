<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rep_enrollmentFinal.aspx.cs" Inherits="rep_enrollmentFinal" %>
...
<body>
    ...
    <div id="dSelection">
        ...
        <asp:RadioButton runat="server" ID="rbSummaryGender" Text="Summary Report by Gender" GroupName="rad1" /><br />
        </div>
        ...
        <td><asp:LinkButton runat="server" ID="lnkBackHome" Text="Return" 
                onclick="lnkBackHome_Click">Return to Home Page</asp:LinkButton></td>
        </tr>
        </table>
