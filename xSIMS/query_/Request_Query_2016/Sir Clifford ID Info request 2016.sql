...
SELECT A.StudNum, A.FullName, B.StudName, H.LevelTypeDesc,UPPER(A.InitialContact) ContactPerson, A.TelNo, A.MobileNo,
UPPER(A.Street) as street, C.BarangayDesc, D.CityDesc, F.ReligionDesc, G.CitizenshipDesc, E.motDescription
